    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        loginButton.registerCallback(mCallbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onCancel() {
                ...
                // ...
                Toast.makeText(registration.this, "Facebook Login Cancelled!", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onError(FacebookException error) {
                Log.d(TAG, "facebook:onError", error);
                Toast.makeText(registration.this, "Facebook Login Failed!", Toast.LENGTH_SHORT).show();
                // ...
            }
...
// ...
    ...
    private void userLogin()
    {
        ...
        firebaseAuth.createUserWithEmailAndPassword(username_str,password_str).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task)
            {
                ...
                {
                    Toast.makeText(registration.this, "Error:Could not login.  Please try again.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
